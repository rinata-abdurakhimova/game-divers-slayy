...
- Authored terrain `x,y` values are exact single-block placements from the board. Do not expand one
  coordinate into a filled column unless the board explicitly lists those lower blocks too.
